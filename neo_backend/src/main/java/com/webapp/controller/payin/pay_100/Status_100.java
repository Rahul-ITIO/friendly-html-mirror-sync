...
public class Status_100 {

    /**
     * Maps the input payload according to Status_100 requirements
    ...
    public Object mapPayload(Object payloadObj) {
        ...
        */
        ...
        String statusGatewayUrl = (String) payload.get("connectorStatusUrl");
        if (statusGatewayUrl == null || statusGatewayUrl.isEmpty()) {
            statusGatewayUrl = "https://ipg.i15.tech/fetch_trnsStatus";
        }
        statusGatewayUrl = statusGatewayUrl+"?transID="+payload.get("connectorRef");

        mappedPayload.put("gatewayUrl", statusGatewayUrl);
        ...
        try {
            ...
            mappedPayload.put("message", "Failed to process status: " + e.getMessage());
            e.printStackTrace();
        }
        ...
        System.out.println("Mapped payload in Status_100: " + mappedPayload);
    ...
    private Map<String, Object> processStatusRequest(Map<String, Object> requestData) throws IOException {
        ...
        try {
            ...
            String apiUrl = requestData.containsKey("gatewayUrl") ? 
                ...
                "https://default-status-gateway.com/api";
            ...
            Object responseObj = parsedResponse.get("response");
            Object statusObj = parsedResponse.get("status");

            if (responseObj != null && responseObj.toString().trim().length() > 0) {
                connectorResponseMsg = responseObj.toString();
            } else if (statusObj != null && statusObj.toString().trim().length() > 0) {
                connectorResponseMsg = statusObj.toString();
            } else {
                connectorResponseMsg = "Unknown"; // or any default message
            }
            ...
            result.put("message", "Error processing status via Status_100 : " + e.getMessage());
            e.printStackTrace();
        }
