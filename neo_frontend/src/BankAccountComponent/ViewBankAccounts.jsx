...
const ViewBankAccounts = () => {
  ...
  const retrieveAllAccounts = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/api/bank/account/fetch/bankwise?bankId=` +
        bank.bank.id,
      {
        headers: {
  ...
  const retrieveAllAccountsByBankAccount = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/api/bank/account/search?bankId=` +
        bank.bank.id +
        "&accountNumber=" +
        accountNumber,
      {
  ...
  const openAccount = (accountId, e) => {
    ...
    fetch(`${process.env.REACT_APP_BASE_URL}/api/bank/account/update/status`, {
      method: "POST",
      headers: {
